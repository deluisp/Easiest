Public NotInheritable Class ListaPlatos
    ...
    Public Function Nuevo(ByVal Nombre As String, ByVal Descripcion As String, ByVal EsBebida As Integer, ByVal Precio As Double, ByVal Tipo As Integer) As Integer
    ...
    Public Function GetTipo(ByVal Nombre As String) As Integer
        For i = 0 To Lista.Count - 1
            If (Lista(i).Nombre = Nombre) Then
                Return Lista(i).Tipo
            End If
